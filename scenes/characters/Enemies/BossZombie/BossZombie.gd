...
const ZOMBIE = preload("res://scenes/characters/Enemies/Zombie/Zombie.tscn")
const BABIES = preload("res://scenes/characters/Enemies/BossZombie/BossZombieBabies.tscn")
